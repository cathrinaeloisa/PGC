		...
		<div class="pure-u-17-24">
			...
			<div class="row">
				<div class="page-header">
					<h1> Cylinder Transaction Records</h1>
				</div>
			</div>
			
			<div class="row">
				<form action="show-cylinder-history.php" method="post" class="form-horizontal" id="cylinderSelectionForm">
